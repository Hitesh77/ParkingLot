...
public class Driver {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        lot.addSpot(new ParkingSpot(1, ParkingSpotType.ACCESSIBLE));
        lot.addSpot(new ParkingSpot(2, ParkingSpotType.COMPACT));
        lot.addSpot(new ParkingSpot(3, ParkingSpotType.LARGE));
        lot.addSpot(new ParkingSpot(5, ParkingSpotType.LARGE));
        lot.addSpot(new ParkingSpot(4, ParkingSpotType.MOTORCYCLE));
